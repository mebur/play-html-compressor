 ...
 */
package com.github.fkoehler.play.xmlcompressor.java;

import akka.stream.Materializer;
import akka.util.ByteString;
import com.github.fkoehler.play.xmlcompressor.XMLCompressorFilter;
import com.github.fkoehler.play.xmlcompressor.fixtures.RequestHandler;
import com.github.fkoehler.play.xmlcompressor.fixtures.java.CustomXMLCompressorFilter;
import com.github.fkoehler.play.xmlcompressor.fixtures.java.DefaultFilter;
import com.github.fkoehler.play.xmlcompressor.fixtures.java.WithGzipFilter;
...
/**
 * Test case for the [[com.github.fkoehler.play.xmlcompressor.java.XMLCompressorFilter]] class.
 */
public class XMLCompressorFilterTest {
    ...
    public void defaultWithGzipFilterXmlCompressesAndThenGzipsResult() {
        running(gzipApp(), () -> {
            ...
            Assertions.assertThat(Helper.gunzip(contentAsBytes(gzipped))).isEqualTo(contentAsBytes(original));
        });
    }
    ...
    public void defaultWithGzipFilterNotCompressGzippedResult() {
        running(gzipApp(), () -> {
            try {
                ...
                Assertions.assertThat(Helper.gunzip(contentAsBytes(result, gzipApp().injector().instanceOf(Materializer.class)))).isEqualTo(original);
            } catch (IOException e) {
